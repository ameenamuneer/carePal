 ...
 * Playback starts automatically when samples are fed and stops when no more
        ...
        try {
            switch (call.method) {
                ...
                case "setup": {
                    ...
                    int channelConfig = (mNumChannels == 2) ? AudioFormat.CHANNEL_OUT_STEREO
