...
class _ActivityLogScreenState extends State<ActivityLogScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (patientProvider.activePatientId != null) {
        logProvider.setPatientAndReload(patientProvider.activePatientId);
      }
    });
        ...
        children: [
          if (provider.filterType != null)
            _FilterChip(
              ...
              onRemove: () =>
                  provider.setFilters(isNotable: provider.filterNotable),
            ),
          if (provider.filterNotable == true)
            _FilterChip(
              ...
              onRemove: () =>
                  provider.setFilters(activityType: provider.filterType),
            ),
          const Spacer(),
          TextButton(
            ...
            children: [
              ...
              Wrap(
                ...
                children: _activityTypes.map((type) {
                  ...
                  final isSelected =
                      isAll ? selectedType == null : selectedType == type;
                  return ChoiceChip(
                    label: Text(
                    ...
                    selected: isSelected,
                    selectedColor:
                        isAll ? AppColors.primary : _typeColor(type),
                    backgroundColor: AppColors.background,
              ...
              SizedBox(
                  height: MediaQuery.of(ctx).viewInsets.bottom + 8),
            ],
          ),
        ),
      ),
